  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className={`absolute inset-0 bg-gradient-to-b from-white via-gray-100 to-gray-200 dark:from-black/50 dark:via-black dark:to-black/90 transition-colors duration-300`}
        />
      </div>
      ...
      <div className="container relative mx-auto px-4 py-8 sm:py-12 md:py-16">
        <div className="grid grid-cols-1 gap-8 sm:gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <span
                className={`text-xl sm:text-2xl font-bold bg-gradient-to-r from-violet-400 via-blue-400 to-violet-400 bg-clip-text text-transparent`}
              >
                David Ayim Obuobi.
              </span>
              <p
                className={`mt-2 text-sm leading-relaxed max-w-md mx-auto md:mx-0 text-gray-600 dark:text-gray-400 transition-colors duration-300`}
              >
          ...
          <div className="space-y-4">
            <h3
              className={`text-lg font-semibold text-center md:text-left text-gray-800 dark:text-white transition-colors duration-300`}
            >
              Quick Links
            </h3>
              ...
              {["About", "Projects", "Blog", "Contact"].map((item, index) => (
                ...
                >
                  <Link
                    ...
                    className={`text-sm flex items-center gap-1.5 group justify-center md:justify-start text-gray-600 hover:text-blue-500 dark:text-gray-400 dark:hover:text-violet-400 transition-colors duration-300`}
                  >
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  transition={{ duration: 0.3, delay: index * 0.1 }}
                  className={`p-2 rounded-lg border transition-all duration-300 group bg-gray-100 border-gray-300 hover:border-gray-400 dark:bg-white/5 dark:border-white/10 dark:hover:border-white/20`}
        ...
        <motion.div
          ...
          className={`mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-300 dark:border-white/10 transition-colors duration-300`}
        >
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
            ...
            <div
              className={`flex items-center gap-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300`}
            >

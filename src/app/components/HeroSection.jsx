      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                <span className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full bg-white/5 backdrop-blur-xl border border-primary-500/30 hover:border-primary-500/50 transition-all duration-300 group">
                  <span className="relative flex h-2 w-2 sm:h-2.5 sm:w-2.5">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary-400 opacity-75" />
                    <span className="relative inline-flex rounded-full h-full w-full bg-primary-400" />
                  </span>
                  <span className="text-xs sm:text-sm font-medium bg-gradient-to-r from-primary-300 via-white to-secondary-300 bg-clip-text text-transparent">
              ...
              <h1 className="text-white text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold leading-tight">
                ...
                <TypeAnimation
                  ...
                  speed={40}
                  repeat={Infinity}
                  className="text-white inline-block bg-gradient-to-r from-primary-400 via-white to-secondary-600 bg-clip-text text-transparent"
                />
              </h1>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 justify-center lg:justify-start">
                {skillBadges.map((badge, index) => (
                  <motion.div
                    ...
                    className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/5 backdrop-blur-lg border border-white/10 flex items-center gap-1.5 sm:gap-2"
                  >
                    {badge.icon}
            ...
            >
              Crafting <span className="text-primary-300 font-semibold">digital experiences</span> that 
              blend innovation with functionality. Specializing in modern web 
              development with a focus on <span className="text-secondary-300 font-semibold">performance</span> and 
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              ...
              >
                <Link
                  ...
                  className="group relative flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-white/10 text-white font-medium text-sm sm:text-base backdrop-blur-xl transition-all duration-500 hover:bg-white/20 hover:scale-105 w-full"
                >
        ...
        >
          <motion.div 
            ...
            className="w-8 h-8 sm:w-10 sm:h-10 border-2 border-white/20 rounded-full flex items-center justify-center backdrop-blur-sm"
          >
            <motion.div 
